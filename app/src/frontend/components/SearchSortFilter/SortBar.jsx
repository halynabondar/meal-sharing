...
function SortBar() {
    const {setFilters} = useSearch(); // Access setFilters from the context
    ...
    const handleSortChange = (e) => {
        ...
        setFilters({sortBy: selectedSort}); // Update filters in context
    }
        ...
        <>
            <fieldset className={styles.panel}>
                ...
                <div className={styles.items}>
                    ...
                    <div className={styles.item}>
                        <input className={styles.input} value="date" checked={sortOptions === "date"} onChange={handleSortChange} type="radio" id="date" name="sortBy"></input>
